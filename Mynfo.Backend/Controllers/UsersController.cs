...
namespace Mynfo.Backend.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserId,FirstName,LastName,Email,ImagePath,UserTypeId,Share")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserId,FirstName,LastName,Email,ImagePath,UserTypeId,Share")] User user)
        {
            if (ModelState.IsValid)
            {
