namespace Mynfo.ViewModels
{
    ...
    public class EditProfileLinkedinViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructor
        public EditProfileLinkedinViewModel(int _ProfileMSId)
        {
        ...
        private async void Delete()
        {
            ...
            MainViewModel.GetInstance().ProfilesByLinkedin.removeProfile();
