namespace Mynfo.ViewModels
{
    ...
    using Xamarin.Forms;
    public class EditProfileTelegramViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructor
        public EditProfileTelegramViewModel(int _ProfileMSId)
        {
        ...
        private async void Save()
        {
            ...
            if (!(this.profileSM.link).ToCharArray().All(Char.IsDigit))
            {
                await Application.Current.MainPage.DisplayAlert(
                    Languages.Error,
                    Languages.NumberValidation,
            ...
            if (this.profileSM.link.Length != 10)
            {
                await Application.Current.MainPage.DisplayAlert(
                    Languages.Error,
            ...
            MainViewModel.GetInstance().ProfilesByTelegram.updateProfile(profile);
        ...
        private async void Delete()
        {
            ...
            MainViewModel.GetInstance().ProfilesByTelegram.removeProfile();
