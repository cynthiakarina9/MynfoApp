namespace Mynfo.ViewModels
{
    ...
    using Xamarin.Forms;
    public class EditProfileTiktokViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructor
        public EditProfileTiktokViewModel(int _ProfileMSId)
        {
        ...
        private async void Save()
        {
            ...
            MainViewModel.GetInstance().ProfilesByTiktok.updateProfile(profile);
        ...
        private async void Delete()
        {
            ...
            MainViewModel.GetInstance().ProfilesByTiktok.removeProfile();
